...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-3.0.58-green" alt="Version">
...
```bash
wget https://github.com/unn-Known1/minimax-agent-linux/releases/download/v3.0.58/minimax-agent_3.0.58_amd64.deb
```
...
# Install
sudo dpkg -i minimax-agent_3.0.58_amd64.deb
